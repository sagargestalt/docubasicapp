...
angular.module('docubasic3App')
  .controller('loginCtrl',['$scope', '$state', '$timeout','$rootScope','$stateParams','$uibModal','loginService','localStorageService','$location','GooglePlus','packageService','billingservice',
  function ($scope, $state, $timeout,$rootScope,$stateParams,$uibModal,loginService,localStorageService,$location,GooglePlus,packageService,billingservice) {
  ...
  var data1 = {
    ...
    $scope.$watch('isLogin', function () {
     ...
     // localStorageService.set('userid',$rootScope.userid);
       ...
       $scope.$watch('profilepath', function () {
       ...
       //$uibModal.close();
        $rootScope.isLogin = true;
                $rootScope.tenancyid = message.data.tenancy_id;
                  ...
                  $rootScope.tenancy_code = message.data.tenancy_code;
                   localStorageService.set('tenancy_code',$rootScope.tenancy_code);
                    $rootScope.profilepath = message.data.image_path;
                 $rootScope.modalInstance.close();
