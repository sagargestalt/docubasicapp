...
$scope.getnotesdata = function(info,i){
	$scope.display = false;
    $scope.edit = false;
...
settingservice.postnote.save((notesdata), function(data){
 ...
 $scope.gettask = function(info){
	...
	$scope.alltaskfinish = function(){
        sweetAlert.swal({
                title: "Are you sure,you want complete all the task?",
                //text: "Your will not be able to recover this imaginary file!",
                type: "success",
                showCancelButton: true,
                confirmButtonColor: "#DD6B55",
	...
	$scope.opentask = function(info){
        sweetAlert.swal({
                title: "Are you sure,you you want to reactivate this task?",
                //text: "Your will not be able to recover this imaginary file!",
                type: "warning",
                showCancelButton: true,
                confirmButtonColor: "#DD6B55",
