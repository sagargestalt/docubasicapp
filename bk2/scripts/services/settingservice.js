...
angular.module('docubasic3App').factory('settingservice', ['$resource', 'apiUrl',function ($resource, apiUrl) {
      ...
      return{
       ...
       getpraposaldata:$resource(apiUrl.praposalcountdata, {id:'@id'} ,{
        ...
        getallusersdetial:$resource(apiUrl.singleuser, {id:'@id'} ,{
          query: {method:'GET'}
        }),
        getresourcedetail:$resource(apiUrl.resourceprice, {} ,{
          get: {method:'GET', params: {} , isArray:false}
        }),
        ...
        getbiilinggraph:$resource(apiUrl.billinggraph, {} ,{
          save: {method:'POST', params: {} , isArray:false}


        }),
        getcostprofitgraph:$resource(apiUrl.costprofitgraph, {} ,{
          save: {method:'POST', params: {} , isArray:false}
        ...
        changeprofile:$resource(apiUrl.userlogo, {} ,{
          save: {method:'POST', params: {} , isArray:false}
      ...
      resentactivity:$resource(apiUrl.resentactivitydata, {} ,{
          save: {method:'POST', params: {} , isArray:false}
      }),

      anasearch:$resource(apiUrl.searchanalys, {} ,{
          save: {method:'POST', params: {} , isArray:false}
      }),
      search:$resource(apiUrl.searchquery, {} ,{
          save: {method:'POST', params: {} , isArray:false}
      }),
      charttask:$resource(apiUrl.getchart, {} ,{
          save: {method:'POST', params: {} , isArray:false}
      }),
      charttaskloss:$resource(apiUrl.getchartloss, {} ,{
          save: {method:'POST', params: {} , isArray:false}
      }),
      charttaskown:$resource(apiUrl.getchartown, {} ,{
          save: {method:'POST', params: {} , isArray:false}
      }),
      ...
      updateprofile:$resource(apiUrl.profileupdate, {} ,{
            save: {method:'POST', params: {} , isArray:false}
      }),
